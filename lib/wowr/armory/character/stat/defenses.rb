      ...
      module Stat
        class Defenses
          ...
          def initialize(elem)
            ...
            @dodge      = Wowr::Armory::Character::Defenses::Avoidance.new(elem%'dodge')
            @parry      = Wowr::Armory::Character::Defenses::Avoidance.new(elem%'parry')
            @block      = Wowr::Armory::Character::Defenses::Avoidance.new(elem%'block')
